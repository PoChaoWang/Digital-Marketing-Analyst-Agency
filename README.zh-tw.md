...
- 在 `reference/GLOSSARY.md` 補 LINE Ads 常見術語。
...
- 想改術語與縮寫：改 `reference/GLOSSARY.md`。
- 想改報告長相：改 `templates/`。
...
- `reference/MCP_SETUP.md`：MCP 與資料來源安全規則。
- `reference/GLOSSARY.md`：名詞對照表。
- `reference/GOOGLE_SHEETS_REPORTING.md`：Google Sheets 報表流程。
